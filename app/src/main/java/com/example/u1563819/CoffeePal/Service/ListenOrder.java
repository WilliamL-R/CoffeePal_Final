package com.example.u1563819.CoffeePal.Service;
...
import com.example.u1563819.CoffeePal.OrderStatus;
...
public class ListenOrder extends Service implements ChildEventListener {
    ...
    private void showNotification(String key, Request request) {
        ...
        intent.putExtra("userName",request.getName());
